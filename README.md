...
| alertmanager.&ZeroWidthSpace;sidecar.&ZeroWidthSpace;containerSecurityContext.&ZeroWidthSpace;allowPrivilegeEscalation | bool | `false` |  |
| alertmanager.&ZeroWidthSpace;sidecar.&ZeroWidthSpace;containerSecurityContext.&ZeroWidthSpace;enabled | bool | `true` |  |
| alertmanager.&ZeroWidthSpace;sidecar.&ZeroWidthSpace;containerSecurityContext.&ZeroWidthSpace;fsGroup | int | `0` | The kopf-k8s-sidecar by default uses a USER/GROUP (65534:65534) for the Image. This is fine if it would match whatever is used in cortex. Since user/group root is the default for this chart we also start the sidecar container as user/group root and therefore overwrite what is defined in the Dockerfile of kopf-k8s-sidecar. If you don't adjust the unix permissions you can have file permission errors! |
...
| alertmanager.&ZeroWidthSpace;sidecar.&ZeroWidthSpace;containerSecurityContext.&ZeroWidthSpace;runAsGroup | int | `0` | The kopf-k8s-sidecar by default uses a USER/GROUP (65534:65534) for the Image. This is fine if it would match whatever is used in cortex. Since user/group root is the default for this chart we also start the sidecar container as user/group root and therefore overwrite what is defined in the Dockerfile of kopf-k8s-sidecar. If you don't adjust the unix permissions you can have file permission errors! |
| alertmanager.&ZeroWidthSpace;sidecar.&ZeroWidthSpace;containerSecurityContext.&ZeroWidthSpace;runAsUser | int | `0` | The kopf-k8s-sidecar by default uses a USER/GROUP (65534:65534) for the Image. This is fine if it would match whatever is used in cortex. Since user/group root is the default for this chart we also start the sidecar container as user/group root and therefore overwrite what is defined in the Dockerfile of kopf-k8s-sidecar. If you don't adjust the unix permissions you can have file permission errors! |
...
| ruler.&ZeroWidthSpace;sidecar.&ZeroWidthSpace;containerSecurityContext.&ZeroWidthSpace;allowPrivilegeEscalation | bool | `false` |  |
| ruler.&ZeroWidthSpace;sidecar.&ZeroWidthSpace;containerSecurityContext.&ZeroWidthSpace;enabled | bool | `true` |  |
| ruler.&ZeroWidthSpace;sidecar.&ZeroWidthSpace;containerSecurityContext.&ZeroWidthSpace;fsGroup | int | `0` | The kopf-k8s-sidecar by default uses a USER/GROUP (65534:65534) for the Image. This is fine if it would match whatever is used in cortex. Since user/group root is the default for this chart we also start the sidecar container as user/group root and therefore overwrite what is defined in the Dockerfile of kopf-k8s-sidecar. If you don't adjust the unix permissions you can have file permission errors! |
| ruler.&ZeroWidthSpace;sidecar.&ZeroWidthSpace;containerSecurityContext.&ZeroWidthSpace;readOnlyRootFilesystem | bool | `true` |  |
| ruler.&ZeroWidthSpace;sidecar.&ZeroWidthSpace;containerSecurityContext.&ZeroWidthSpace;runAsGroup | int | `0` | The kopf-k8s-sidecar by default uses a USER/GROUP (65534:65534) for the Image. This is fine if it would match whatever is used in cortex. Since user/group root is the default for this chart we also start the sidecar container as user/group root and therefore overwrite what is defined in the Dockerfile of kopf-k8s-sidecar. If you don't adjust the unix permissions you can have file permission errors! |
| ruler.&ZeroWidthSpace;sidecar.&ZeroWidthSpace;containerSecurityContext.&ZeroWidthSpace;runAsUser | int | `0` | The kopf-k8s-sidecar by default uses a USER/GROUP (65534:65534) for the Image. This is fine if it would match whatever is used in cortex. Since user/group root is the default for this chart we also start the sidecar container as user/group root and therefore overwrite what is defined in the Dockerfile of kopf-k8s-sidecar. If you don't adjust the unix permissions you can have file permission errors! |

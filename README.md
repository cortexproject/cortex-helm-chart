...
| nginx.&ZeroWidthSpace;config.&ZeroWidthSpace;dnsTTL | optional | `"15s"` | Including the valid parameter to the `resolver` directive to re-resolve names every `dnsTTL` seconds/minutes |

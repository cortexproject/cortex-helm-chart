...
| alertmanager.podSecurityContext | object | `{ "enabled": true, "readOnlyRootFilesystem": true  }` |  |
...
| compactor.podSecurityContext | object | `{ "enabled": true, "readOnlyRootFilesystem": true  }` |  |
...
| configs.podSecurityContext | object | `{ "enabled": true, "readOnlyRootFilesystem": true  }` |  |
...
| distributor.podSecurityContext | object | `{ "enabled": true, "readOnlyRootFilesystem": true  }` |  |
...
| ingester.podSecurityContext | object | `{ "enabled": true, "readOnlyRootFilesystem": true  }` |  |
...
| nginx.podSecurityContext | object | `{ "enabled": true, "readOnlyRootFilesystem": true  }` |  |
...
| querier.podSecurityContext | object | `{ "enabled": true, "readOnlyRootFilesystem": true  }` |  |
...
| query_frontend.podSecurityContext | object | `{ "enabled": true, "readOnlyRootFilesystem": true  }` |  |
...
| ruler.podSecurityContext | object | `{ "enabled": true, "readOnlyRootFilesystem": true  }` |  |
...
| store_gateway.podSecurityContext | object | `{ "enabled": true, "readOnlyRootFilesystem": true  }` |  |
...
| table_manager.podSecurityContext | object | `{ "enabled": true, "readOnlyRootFilesystem": true  }` |  |
